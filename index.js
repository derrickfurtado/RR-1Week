...
let faveDrink = "Monster Zero Ultra"
...
let total = youtube + netflix + hulu + disney + peacock

console.log("Total cost of subscriptions: ",total)
...
// total = youtube + netflix + hulu + disney + peacock



{console.log("New Total 1: ", total)}
...
value to all of your subscription variables 
   ...
   let newTotal = youtube + netflix + hulu + disney + peacock

   console.log("New total 2: ", newTotal)
...
{console.log("Savings as a percentage: ", savings)}
